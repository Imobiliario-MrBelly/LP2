...
<body>
    ...
    <div style="width: 99%;">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <iframe src="./menu.html" frameborder="0" title="menu" style="height: 500px;"></iframe>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class='container'>
                                <div class="row">
                                    <div class="col-md-3">
                                        <label><input required type="radio" name="tipoImovel" id="casa" value="casa"> Casa</label>
                                    </div>
                                    <div class="col-md-3">
                                        <label><input required type="radio" name="tipoImovel" id="apartamento" value="apartamento"> Apartamento</label>
                                    </div>
                                    <div class="col-md-3">
                                        <label><input required type="radio" name="tipoImovel" id="comercial" value="comercial"> Comercial</label>
                                    </div>
                                    <div class="col-md-3">
                                        <label><input required type="radio" name="tipoImovel" id="garagem" value="garagem"> Garagem</label>
                                    </div>
                                </div>
                                <div class='row'>
                                    <div class='col-md-12'>
