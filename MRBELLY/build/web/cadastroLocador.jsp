            ...
            <div class='col-md-4 py-4 px-4' style='background-color: #fdfffc;'>
                    ...
                    <div class='container h-100 mt-4'>
                        ...
                        <div class='row mt-4 mb-5 mx-1 d-flex'>
                            <div class='row col-md-6 align-items-center'>
                                <input class="col-4" type='radio' name='tipoPessoa' id='pessoaFisica' value='fisica' onclick='tipo(this.value)'><label class="col-8" for='fisica'> Pessoa Fisica</label>
                            </div>
                            <div class='row col-md-6 align-items-center'>
                                <input class="col-3" type='radio' name='tipoPessoa' id='pessoaJuridica' value='juridica' onclick='tipo(this.value)'><label class="col-9" for='juridica'> Pessoa Jurídica</label>
                            </div>
                        </div>
                    ...
                    <div class='container'>
                        ...
                        <div id='quadroPessoaFisica'>
                            ...
                            <div class='row mb-4'>
                                ...
                                <div class='col-md-12'>
                                    <input class="px-2" type='date' name='nascimento' id='nascimento'>
                                </div>
                            </div>
                            <div class='row mt-2 mx-1'>
                                <div class='col-md-6 row align-items-center'>
                                    <input class="col-2" type='radio' name='sexo' id='masculino' value='M'><label class="col-10" for='masculino'> Masculino</label>
                                </div>
                                <div class='row col-md-6 align-items-center'>
                                    <input class="col-2" type='radio' name='sexo' id='feminino' value='F'><label class="col-10" for='feminino'> Feminino</label>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-body'>
                                            ...
                                            <div class='row mb-2 mt-3 mx-1'>
                                                ...
                                                <div class='col-md-6 row align-items-center'>
                                                    <input class="col-2" type='radio' name='sexo' id='feminino' value='F'><label for='feminino' class="col-10"> Feminino</label>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div id="etapa4">
                    <div class=' container'>
                        ...
                        <div class='row mb-3'>
                            <div class='col-md-12'>
                                <input type="password" name="confirmaSenha" id="connfirmaSenha">
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-md-6'>
